...
void diffeqs(long double vars[], long double diffs[])
{
	...
	diffs[3] = -christ[1][0][0] * dt * dt - 2.0 * christ[1][0][1] * dt * dr - 2.0 * christ[1][0][2] * dt * dth - 2.0 * christ[1][0][3] * dt * dphi - christ[1][1][1] * dr * dr - 2.0 * christ[1][1][2] * dr * dth - 2.0 * christ[1][1][3] * dr * dphi - christ[1][2][2] * dth * dth - 2.0 * christ[1][2][3] * dth * dphi - christ[1][3][3] * dphi * dphi; // d2r
	diffs[4] = -christ[2][0][0] * dt * dt - 2.0 * christ[2][0][1] * dt * dr - 2.0 * christ[2][0][2] * dt * dth - 2.0 * christ[2][0][3] * dt * dphi - christ[2][1][1] * dr * dr - 2.0 * christ[2][1][2] * dr * dth - 2.0 * christ[2][1][3] * dr * dphi - christ[2][2][2] * dth * dth - 2.0 * christ[2][2][3] * dth * dphi - christ[2][3][3] * dphi * dphi; // d2th
	diffs[5] = -christ[3][0][0] * dt * dt - 2.0 * christ[3][0][1] * dt * dr - 2.0 * christ[3][0][2] * dt * dth - 2.0 * christ[3][0][3] * dt * dphi - christ[3][1][1] * dr * dr - 2.0 * christ[3][1][2] * dr * dth - 2.0 * christ[3][1][3] * dr * dphi - christ[3][2][2] * dth * dth - 2.0 * christ[3][2][3] * dth * dphi - christ[3][3][3] * dphi * dphi; // d2phi
}
