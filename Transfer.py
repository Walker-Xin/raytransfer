...
for spin in a:
    ...
    for defpar in defpar_d:
        for i_obs in mu0:
            ...
            filename = r'C:\Users\WalkerXin\Downloads\raytransfer-main\photons\photons4trf_a5.00000e-001.i7.07e-001.Mdl_0.00e+000.dp_7.85e-318.dat'
            ...
            re, g, xobs, yobs, cosem, gminus, xobsminus, yobsminus, gplus, xobsplus, yobsplus = np.loadtxt(
            ...
            fits_g_star1 = np.zeros([100, 40])
            fits_g_star2 = np.zeros([100, 40])
            ...
            for i in np.arange(1, 101):
                ...
                for j in range(1, 41):
                    ...
                    trff1.append(gcur*np.sqrt((gmax-gcur)*(gcur-gmin))*jac/(np.pi*recur))
                    cosem1.append(cosem[poscur])
                    g_star1.append(g_star)
                ...
                for j in range(43, 83):
                    ...
                    trff2.append(gcur*np.sqrt((gmax-gcur)*(gcur-gmin))*jac/(np.pi*recur))
                    cosem2.append(cosem[poscur])
                    g_star2.append(g_star)
                ...
                fits_g_star1[i-1] = g_star1
                fits_g_star2[i-1] = g_star2
            ...
            col8 = fits.Column(name='g_star1', format='40E', array=fits_g_star1)
            col9 = fits.Column(name='g_star2', format='40E', array=fits_g_star2)
