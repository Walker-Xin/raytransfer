...
double t22 = 8*t21;
double t23 = 8*t13*t4;
double t25 = 8*t13*t24*t4;
double t26 = 8*r*t18*t24;
double t27 = 3*t1*t18;
double t28 = 12*t1*t18*t24;
double t29 = pow(spin,6);
double t30 = 4*t24*t29;
double t31 = t2*t24;
double t32 = r + t31;
double t33 = r*t32*t4;
double t34 = t18*t24;
double t35 = t14 + t33 + t34;
double t36 = 4*t35*t4*t9;
double t37 = 4*th;
double t38 = cos(t37);
double t39 = t1*t18*t38;
double t40 = t22 + t23 + t25 + t26 + t27 + t28 + t30 + t36 + t39;
double t41 = 1/t40;
double t6 = 1/t5;
double t7 = 2*t1;
double t11 = t4*t9;
double t12 = t11 + t4 + t7;
double t43 = 4*defpar*r*spin*t20*t41;
double t44 = pow(r,3);
double t45 = -8*spin*t12*t41*t44*t6;
double t47 = 16*defpar*t1*t4*t41;
gu[0][0] = -2*t1*t12*t20*t41*t6;
gu[0][1] = t43;
gu[0][2] = 0;
gu[0][3] = t45;
gu[1][0] = t43;
gu[1][1] = 4*t1*t12*t41*t5;
gu[1][2] = 0;
gu[1][3] = t47;
gu[2][0] = 0;
gu[2][1] = 0;
...
gu[3][1] = t47;
gu[3][2] = 0;
gu[3][3] = 2*t12*t41*t6*(2*t18*t24 + r*(r + (-4 + 2*r)*t24)*t4 + 2*t2*t44 + t1*t4*t9)*pow(1/sin(th),2);
}
